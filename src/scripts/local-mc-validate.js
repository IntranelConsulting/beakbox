!(function (e, t) {
    ...
    if (ee.acceptData(e)) {
      ...
      if ((d && c[d] && (i || c[d].data)) || !u || r !== t)
        return (
          ...
          ("object" == typeof n || "function" == typeof n) && (i ? (c[d] = ee.extend(c[d], n)) : (c[d].data = ee.extend(c[d].data, n))),
          (a = c[d]),
  ...
  function v(e, t) {
    ...
    if (1 === t.nodeType) {
      ...
      "script" === n && t.text !== e.text
        ? ((p(t).text = e.text), h(t))
        : "object" === n
        ? (t.parentNode && (t.outerHTML = e.outerHTML), ee.support.html5Clone && e.innerHTML && !ee.trim(t.innerHTML) && (t.innerHTML = e.innerHTML))
  ...
  function T(e, t) {
    for (var n, r = [], i = 0, a = e.length; a > i; i++)
      (n = e[i]).style &&
        ...
        t
          ? (r[i] || "none" !== n.style.display || (n.style.display = ""), "" === n.style.display && w(n) && (r[i] = ee._data(n, "olddisplay", N(n.nodeName))))
  ...
  function k(e, t, n, r, i) {
    for (var a = n === (r ? "border" : "content") ? 4 : "width" === t ? 1 : 0, o = 0; 4 > a; a += 2)
      "margin" === n && (o += ee.css(e, n + pt[a], !0, i)),
        r
          ? ("content" === n && (o -= ee.css(e, "padding" + pt[a], !0, i)), "margin" !== n && (o -= ee.css(e, "border" + pt[a] + "Width", !0, i)))
          : ((o += ee.css(e, "padding" + pt[a], !0, i)), "padding" !== n && (o += ee.css(e, "border" + pt[a] + "Width", !0, i)));
    return o;
  }
  ...
  function N(e) {
    ...
    return (
      n ||
        (("none" !== (n = E(e, t)) && n) ||
          ((t = ((tt = (tt || ee("<iframe frameborder='0' width='0' height='0'/>").css("cssText", "display:block !important")).appendTo(t.documentElement))[0].contentWindow || tt[0].contentDocument)
  ...
  (ee.fn = ee.prototype =
    {
      ...
      init: function (e, n, r) {
        ...
        if (!e) return this;
        if ("string" == typeof e) {
          if (!(i = "<" === e.charAt(0) && ">" === e.charAt(e.length - 1) && e.length >= 3 ? [null, e, null] : ie.exec(e)) || (!i[1] && n))
        ...
        return e.nodeType
          ...
          : ee.isFunction(e)
          ? r.ready(e)
          : (e.selector !== t && ((this.selector = e.selector), (this.context = e.context)), ee.makeArray(e, this));
      },
      selector: "",
      length: 0,
      size: function () {
              ...
              (r = s[n]),
                s !== (i = e[n]) &&
                  (c && i && (ee.isPlainObject(i) || (a = ee.isArray(i)))
                    ? (a ? ((a = !1), (o = r && ee.isArray(r) ? r : [])) : (o = r && ee.isPlainObject(r) ? r : {}), (s[n] = ee.extend(c, o, i)))
                    : i !== t && (s[n] = i));
        return s;
      }),
    ee.extend({
      ...
      parseJSON: function (n) {
        return e.JSON && e.JSON.parse
          ...
          : null === n
          ? n
          : "string" == typeof n && (n = ee.trim(n)) && oe.test(n.replace(ue, "@").replace(le, "]").replace(se, ""))
          ? Function("return " + n)()
      ...
      map: function (e, t, r) {
        var i,
          ...
          o = e.length,
          s = [];
        if (n(e)) for (; o > a; a++) null != (i = t(e[a], a, r)) && (s[s.length] = i);
      ...
      access: function (e, n, r, i, a, o, s) {
        var u = 0,
          l = e.length,
          c = null == r;
        if ("object" === ee.type(r)) for (u in ((a = !0), r)) ee.access(e, n, u, r[u], !0, o, s);
        else if (
          i !== t &&
          ((a = !0),
          ee.isFunction(i) || (s = !0),
  ...
  (ee.Callbacks = function (e) {
    ...
    (ee.support = (function () {
      ...
      if (
        ...
        return {};
      (o = (a = B.createElement("select")).appendChild(B.createElement("option"))),
      ...
      return (
        ...
        ee(function () {
          ...
          s &&
            (((r = B.createElement("div")).style.cssText = "border:0;width:0;height:0;position:absolute;top:0;left:-9999px;margin-top:1px"),
            ...
            e.getComputedStyle &&
              ((n.pixelPosition = "1%" !== (e.getComputedStyle(f, null) || {}).top),
              (n.boxSizingReliable =
                "4px" ===
                (
              ...
              ((i = f.appendChild(B.createElement("div"))).style.cssText = f.style.cssText = o),
  ...
  ee.fn.extend({
    ...
    toggleClass: function (e, t) {
      ...
      return ee.isFunction(e)
        ...
        : this.each(function () {
            if ("string" === n) for (var i, a = 0, o = ee(this), s = t, u = e.match(ne) || []; (i = u[a++]); ) (s = r ? s : !o.hasClass(i)), o[s ? "addClass" : "removeClass"](i);
            else
              ("undefined" === n || "boolean" === n) &&
                (this.className && ee._data(this, "__className__", this.className), (this.className = this.className || !1 === e ? "" : ee._data(this, "__className__") || ""));
          });
    },
    hasClass: function (e) {
    ...
    val: function (e) {
      ...
      return arguments.length
        ...
        : a
        ? (n = ee.valHooks[a.type] || ee.valHooks[a.nodeName.toLowerCase()]) && "get" in n && (r = n.get(a, "value")) !== t
          ? r
    ...
    ee.extend({
        ...
        select: {
          get: function (e) {
            for (var t, n, r = e.options, i = e.selectedIndex, a = "select-one" === e.type || 0 > i, o = a ? null : [], s = a ? i + 1 : r.length, u = 0 > i ? s : a ? i : 0; s > u; u++)
              if (
                !((!(n = r[u]).selected && u !== i) || (ee.support.optDisabled ? n.disabled : null !== n.getAttribute("disabled")) || (n.parentNode.disabled && ee.nodeName(n.parentNode, "optgroup")))
              ) {
      ...
      attr: function (e, n, r) {
        ...
        if (e && 3 !== s && 8 !== s && 2 !== s)
          return e.getAttribute === t
            ? ee.prop(e, n, r)
            : ((o = 1 !== s || !ee.isXMLDoc(e)) && ((n = n.toLowerCase()), (a = ee.attrHooks[n] || (Ce.test(n) ? ye : ve))),
              r === t
      ...
      removeAttr: function (e, t) {
        ...
        if (a && 1 === e.nodeType)
          for (; (n = a[i++]); )
            (r = ee.propFix[n] || n), Ce.test(n) ? (!Fe && ke.test(n) ? (e[ee.camelCase("default-" + n)] = e[r] = !1) : (e[r] = !1)) : ee.attr(e, n, ""), e.removeAttribute(Fe ? n : r);
      },
      attrHooks: {
        type: {
          set: function (e, t) {
      ...
      prop: function (e, n, r) {
        ...
        if (e && 3 !== o && 8 !== o && 2 !== o)
          return (
            (1 !== o || !ee.isXMLDoc(e)) && ((n = ee.propFix[n] || n), (a = ee.propHooks[n])),
  ...
  (ee.event = {
      ...
      if (v) {
        for (
          ...
          (h = g = (u = je.exec(n[c]) || [])[1]),
            ...
            (p = l[h]) ||
              (((p = l[h] = []).delegateCount = 0), (f.setup && !1 !== f.setup.call(e, i, m, s)) || (e.addEventListener ? e.addEventListener(h, s, !1) : e.attachEvent && e.attachEvent("on" + h, s))),
            f.add && (f.add.call(e, d), d.handler.guid || (d.handler.guid = r.guid)),
      ...
      if (g && (u = g.events)) {
        for (l = (t = (t || "").match(ne) || [""]).length; l--; )
          if (((p = m = (s = je.exec(t[l]) || [])[1]), (h = (s[2] || "").split(".").sort()), p)) {
            for (d = ee.event.special[p] || {}, f = u[(p = (r ? d.delegateType : d.bindType) || p)] || [], s = s[2] && RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), o = a = f.length; a--; )
              (c = f[a]),
                (!i && m !== c.origType) ||
                  (n && n.guid !== c.guid) ||
                  (s && !s.test(c.namespace)) ||
                  (r && r !== c.selector && ("**" !== r || !c.selector)) ||
                  (f.splice(a, 1), c.selector && f.delegateCount--, d.remove && d.remove.call(e, c));
    ...
    trigger: function (n, r, i, a) {
      ...
      if (
        ...
        3 !== i.nodeType &&
          ...
          (c = 0 > h.indexOf(":") && "on" + h),
          ((n = n[ee.expando] ? n : new ee.Event(h, "object" == typeof n && n)).isTrigger = !0),
          (n.namespace = m.join(".")),
        ...
        for (o = 0; (s = p[o++]) && !n.isPropagationStopped(); )
          (n.type = o > 1 ? l : f.bindType || h),
            (d = (ee._data(s, "events") || {})[n.type] && ee._data(s, "handle")) && d.apply(s, r),
            (d = c && s[c]) && ee.acceptData(s) && d.apply && !1 === d.apply(s, r) && n.preventDefault();
        if (
          ((n.type = h),
          !(a || n.isDefaultPrevented() || (f._default && !1 !== f._default.apply(i.ownerDocument, r)) || ("click" === h && ee.nodeName(i, "a"))) && ee.acceptData(i) && c && i[h] && !ee.isWindow(i))
        ) {
    ...
    dispatch: function (e) {
      ...
      if (((u[0] = e), (e.delegateTarget = this), !c.preDispatch || !1 !== c.preDispatch.call(this, e))) {
        for (s = ee.event.handlers.call(this, e, l), n = 0; (a = s[n++]) && !e.isPropagationStopped(); )
          for (e.currentTarget = a.elem, r = 0; (o = a.handlers[r++]) && !e.isImmediatePropagationStopped(); )
            (!e.namespace_re || e.namespace_re.test(o.namespace)) &&
              ((e.handleObj = o),
              (e.data = o.data),
              (i = ((ee.event.special[o.origType] || {}).handle || o.handler).apply(a.elem, u)) !== t && !1 === (e.result = i) && (e.preventDefault(), e.stopPropagation()));
    ...
    (ee.Event = function (e, n) {
      return this instanceof ee.Event
        ? (e && e.type
            ? ((this.originalEvent = e), (this.type = e.type), (this.isDefaultPrevented = e.defaultPrevented || !1 === e.returnValue || (e.getPreventDefault && e.getPreventDefault()) ? s : u))
            : (this.type = e),
          n && ee.extend(this, n),
    ...
    (function (e, t) {
      ...
      function d(e, t) {
        ...
        for (s = e, u = [], l = C.preFilter; s; ) {
          for (a in ((!n || (r = ae.exec(s))) && (r && (s = s.slice(r[0].length) || s), u.push((i = []))),
          (n = !1),
          (r = oe.exec(s)) &&
            ((n = r.shift()),
            i.push({
              ...
              (B.qsa = n(r.querySelectorAll)) &&
                (a(function (e) {
                  (e.innerHTML = "<select><option selected=''></option></select>"),
                    e.querySelectorAll("[selected]").length || _.push("\\[" + Z + "*(?:checked|disabled|ismap|multiple|readonly|selected|value)"),
                    e.querySelectorAll(":checked").length || _.push(":checked");
                }),
                a(function (e) {
                  (e.innerHTML = "<input type='hidden' i=''/>"),
                    e.querySelectorAll("[i^='']").length && _.push("[*^$]=" + Z + "*(?:\"\"|'')"),
                    e.querySelectorAll(":enabled").length || _.push(":enabled", ":disabled"),
                    e.querySelectorAll("*,:x"),
                    _.push(",.*:");
                })),
              (B.matchesSelector = n((M = j.matchesSelector || j.mozMatchesSelector || j.webkitMatchesSelector || j.oMatchesSelector || j.msMatchesSelector))) &&
                a(function (e) {
      ...
      (o.matchesSelector = function (e, t) {
        if (((e.ownerDocument || e) !== A && D(e), (t = t.replace(ge, "='$1']")), !(!B.matchesSelector || L || (q && q.test(t)) || _.test(t))))
          try {
            var n = M.call(e, t);
      ...
      (o.attr = function (e, t) {
        ...
        return (
          ...
          L || (t = t.toLowerCase()),
          (n = C.attrHandle[t]) ? n(e) : L || B.attributes ? e.getAttribute(t) : ((n = e.getAttributeNode(t)) || e.getAttribute(t)) && !0 === e[t] ? t : n && n.specified ? n.value : null
        );
      }),
      (o.error = function (e) {
          ...
          preFilter: {
            ...
            CHILD: function (e) {
              return (
                (e[1] = e[1].toLowerCase()),
                "nth" === e[1].slice(0, 3)
                  ? (e[3] || o.error(e[0]), (e[4] = +(e[4] ? e[5] + (e[6] || 1) : 2 * ("even" === e[3] || "odd" === e[3]))), (e[5] = +(e[7] + e[8] || "odd" === e[3])))
                  : e[3] && o.error(e[0]),
                e
              );
            },
            PSEUDO: function (e) {
              ...
              return le.CHILD.test(e[0])
                ? null
                : (e[4] ? (e[2] = e[4]) : n && se.test(n) && (t = d(n, !0)) && (t = n.indexOf(")", n.length - t) - n.length) && ((e[0] = e[0].slice(0, t)), (e[2] = n.slice(0, t))), e.slice(0, 3));
            },
          },
          filter: {
            TAG: function (e) {
                    ...
                    if (g) {
                      ...
                      if (((h = [o ? g.firstChild : g.lastChild]), o && y)) {
                        ...
                        for (
                          ...
                          ((s ? d.nodeName.toLowerCase() !== v : 1 !== d.nodeType) || !++f || (y && ((d[R] || (d[R] = {}))[e] = [z, f]), d !== t));
            ...
            PSEUDO: function (e, t) {
              var n,
                r = C.pseudos[e] || C.setFilters[e.toLowerCase()] || o.error("unsupported pseudo: " + e);
              return r[R]
                ? r(t)
                : r.length > 1
                ? ((n = [e, e, "", t]),
  ...
  (Je.optgroup = Je.option),
    ...
    ee.fn.extend({
      ...
      remove: function (e, t) {
        for (var n, r = 0; null != (n = this[r]); r++)
          (!e || ee.filter(e, [n]).length > 0) &&
            (t || 1 !== n.nodeType || ee.cleanData(y(n)), n.parentNode && (t && ee.contains(n.ownerDocument, n) && m(y(n, "script")), n.parentNode.removeChild(n)));
        return this;
      },
      empty: function () {
      ...
      replaceWith: function (e) {
        return (
          ee.isFunction(e) || "string" == typeof e || (e = ee(e).not(this).detach()),
      ...
      domManip: function (e, n, r) {
        ...
        var i,
          ...
          v = e[0],
          b = ee.isFunction(v);
        if (b || (!(1 >= d || "string" != typeof v || ee.support.checkClone) && Ue.test(v)))
        ...
        if (d && ((a = (i = ee.buildFragment(e, this[0].ownerDocument, !1, this)).firstChild), 1 === i.childNodes.length && (i = a), a)) {
          for (n = n && ee.nodeName(a, "tr"), s = (o = ee.map(y(i, "script"), p)).length; d > c; c++)
            (u = i), c !== g && ((u = ee.clone(u, !0, !0)), s && ee.merge(o, y(u, "script"))), r.call(n && ee.nodeName(this[c], "table") ? f(this[c], "tbody") : this[c], u, c);
          if (s)
            for (l = o[o.length - 1].ownerDocument, ee.map(o, h), c = 0; s > c; c++)
              (u = o[c]),
                Ye.test(u.type || "") &&
    ...
    ee.extend({
      clone: function (e, t, n) {
        ...
        if (
          (ee.support.html5Clone || ee.isXMLDoc(e) || !Oe.test("<" + e.nodeName + ">") ? (s = e.cloneNode(!0)) : ((Ze.innerHTML = e.outerHTML), Ze.removeChild((s = Ze.firstChild))),
          !((ee.support.noCloneEvent && ee.support.noCloneChecked) || (1 !== e.nodeType && 11 !== e.nodeType) || ee.isXMLDoc(e)))
        )
          for (r = y(s), i = y(e), o = 0; null != (a = i[o]); ++o) r[o] && v(a, r[o]);
        if (t)
          if (n) for (i = i || y(e), r = r || y(s), o = 0; null != (a = i[o]); o++) g(a, r[o]);
          else g(e, s);
          ...
          if ((a = e[g]) || 0 === a)
            if ("object" === ee.type(a)) ee.merge(h, a.nodeType ? [a] : a);
              ...
              if ((!ee.support.leadingWhitespace && Be.test(a) && h.push(t.createTextNode(Be.exec(a)[0])), !ee.support.tbody))
                for (c = (a = "table" !== o || We.test(a) ? ("<table>" !== u[1] || We.test(a) ? 0 : s) : s.firstChild) && a.childNodes.length; c--; )
                  ee.nodeName((l = a.childNodes[c]), "tbody") && !l.childNodes.length && a.removeChild(l);
    ...
    ee.extend({
      ...
      style: function (e, n, r, i) {
        if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
          ...
          if (
            ("string" === (o = typeof r) && (a = lt.exec(r)) && ((r = (a[1] + 1) * a[2] + parseFloat(ee.css(e, n))), (o = "number")),
            !(
              null == r ||
              ("number" === o && isNaN(r)) ||
              ("number" !== o || ee.cssNumber[u] || (r += "px"),
              ee.support.clearCloneStyle || "" !== r || 0 !== n.indexOf("background") || (l[n] = "inherit"),
      ...
      css: function (e, n, r, i) {
        ...
        return (
          ...
          (s = ee.cssHooks[n] || ee.cssHooks[u]) && "get" in s && (a = s.get(e, !0, r)),
          a === t && (a = Ke(e, n, i)),
          "normal" === a && n in ft && (a = ft[n]),
          r ? ((o = parseFloat(a)), !0 === r || ee.isNumeric(o) ? o || 0 : a) : a
        );
      },
    ...
    e.getComputedStyle
      ? ((et = function (t) {
        ...
        (Ke = function (e, n, r) {
          ...
          return (
            s &&
              ("" !== u || ee.contains(e.ownerDocument, e) || (u = ee.style(e, n)),
              ut.test(u) &&
                ot.test(n) &&
                ((i = l.width), (a = l.minWidth), (o = l.maxWidth), (l.minWidth = l.maxWidth = l.width = u), (u = s.width), (l.width = i), (l.minWidth = a), (l.maxWidth = o))),
            u
          );
        }))
    ...
    ee.support.opacity ||
      (ee.cssHooks.opacity = {
        ...
        set: function (e, t) {
          ...
          (n.zoom = 1),
            ((t >= 1 || "" === t) && "" === ee.trim(a.replace(nt, "")) && n.removeAttribute && (n.removeAttribute("filter"), "" === t || (r && !r.filter))) ||
  ...
  (xt = Dt.exec(wt.toLowerCase()) || []),
    (ee.fn.load = function (e, n, r) {
      ...
      return (
        ...
        ee.isFunction(n) ? ((r = n), (n = t)) : n && "object" == typeof n && (a = "POST"),
        s.length > 0 &&
          ee
            .ajax({
              url: e,
      ...
      ajax: function (e, n) {
        function r(e, n, r, s) {
          ...
          2 !== x &&
            ...
            (e >= 200 && 300 > e) || 304 === e
              ? (f.ifModified && ((w = T.getResponseHeader("Last-Modified")) && (ee.lastModified[a] = w), (w = T.getResponseHeader("etag")) && (ee.etag[a] = w)),
                304 === e
                  ? ((l = !0), (C = "notmodified"))
                  : ((C = (l = (function (e, t) {
                      var n,
            ...
            g.fireWith(p, [T, C]),
            c && (h.trigger("ajaxComplete", [T, f]), --ee.active || ee.event.trigger("ajaxStop")));
        }
        ...
        if (
          ...
          (T.success = T.done),
          (T.error = T.fail),
          (f.url = ((e || f.url || wt) + "").replace(kt, "").replace(St, xt[1] + "//")),
          ...
          (f.dataTypes = ee
            ...
            .match(ne) || [""]),
          null == f.crossDomain &&
            ((l = Dt.exec(f.url.toLowerCase())), (f.crossDomain = !(!l || (l[1] === xt[1] && l[2] === xt[2] && (l[3] || ("http:" === l[1] ? 80 : 443)) == (xt[3] || ("http:" === xt[1] ? 80 : 443)))))),
          f.data && f.processData && "string" != typeof f.data && (f.data = ee.param(f.data, f.traditional)),
          A(jt, f, n, T),
          2 === x)
        )
          return T;
        for (d in ((c = f.global) && 0 == ee.active++ && ee.event.trigger("ajaxStart"),
        (f.type = f.type.toUpperCase()),
        (f.hasContent = !Et.test(f.type)),
        (a = f.url),
        f.hasContent ||
          (f.data && ((a = f.url += (Ct.test(a) ? "&" : "?") + f.data), delete f.data),
          !1 === f.cache && (f.url = Ft.test(a) ? a.replace(Ft, "$1_=" + Tt++) : a + (Ct.test(a) ? "&" : "?") + "_=" + Tt++)),
        f.ifModified && (ee.lastModified[a] && T.setRequestHeader("If-Modified-Since", ee.lastModified[a]), ee.etag[a] && T.setRequestHeader("If-None-Match", ee.etag[a])),
        ((f.data && f.hasContent && !1 !== f.contentType) || n.contentType) && T.setRequestHeader("Content-Type", f.contentType),
        T.setRequestHeader("Accept", f.dataTypes[0] && f.accepts[f.dataTypes[0]] ? f.accepts[f.dataTypes[0]] + ("*" !== f.dataTypes[0] ? ", " + _t + "; q=0.01" : "") : f.accepts["*"]),
        f.headers))
  ...
  ee.ajaxSetup({
    ...
    ee.ajaxPrefilter("json jsonp", function (n, r, i) {
      ...
      return u || "jsonp" === n.dataTypes[0]
        ? ((a = n.jsonpCallback = ee.isFunction(n.jsonpCallback) ? n.jsonpCallback() : n.jsonpCallback),
          u ? (n[u] = n[u].replace(Mt, "$1" + a)) : !1 !== n.jsonp && (n.url += (Ct.test(n.url) ? "&" : "?") + n.jsonp + "=" + a),
                    ...
                    if (r && (i || 4 === u.readyState))
                      if (((r = t), o && ((u.onreadystatechange = ee.noop), Ot && delete Ht[o]), i)) 4 !== u.readyState && u.abort();
                        ...
                        (d = {}),
                          ...
                          "string" == typeof u.responseText && (d.text = u.responseText);
                        try {
                          l = u.statusText;
                        } catch (e) {
                          l = "";
    ...
    Xt = [
      function (e, t, n) {
        ...
        1 === e.nodeType &&
          ...
          "inline" === ee.css(e, "display") && "none" === ee.css(e, "float") && (ee.support.inlineBlockNeedsLayout && "inline" !== N(e.nodeName) ? (p.zoom = 1) : (p.display = "inline-block"))),
        n.overflow &&
          ((p.overflow = "hidden"),
    ...
    (M.propHooks = {
      _default: {
        ...
        set: function (e) {
          ee.fx.step[e.prop]
            ? ee.fx.step[e.prop](e)
            : e.elem.style && (null != e.elem.style[ee.cssProps[e.prop]] || ee.cssHooks[e.prop])
        ...
        return (
          ...
          this.each(function () {
            var t,
              ...
              a = ee.timers,
              o = r ? r.length : 0;
            for (n.finish = !0, ee.queue(this, e, []), i && i.cur && i.cur.finish && i.cur.finish.call(this), t = a.length; t--; )
    ...
    (ee.offset = {
      setOffset: function (e, t, n) {
        ...
        var i,
          ...
          c = {},
          d = {};
        ("absolute" === r || "fixed" === r) && ee.inArray("auto", [u, l]) > -1 ? ((i = (d = o.position()).top), (a = d.left)) : ((i = parseFloat(u) || 0), (a = parseFloat(l) || 0)),
      ...
      (e.fn.ajaxSubmit = function (t) {
        function n(n) {
          ...
          function s() {
            ...
            try {
              if (f.extraData)
                for (var c in f.extraData)
                  f.extraData.hasOwnProperty(c) &&
                    s.push(
                      e.isPlainObject(f.extraData[c]) && f.extraData[c].hasOwnProperty("name") && f.extraData[c].hasOwnProperty("value")
              ...
              f.iframeTarget || g.appendTo("body"),
                v.attachEvent ? v.attachEvent("onload", u) : v.addEventListener("load", u, !1),
            ...
            if (!y.aborted && !j) {
              ...
              if ((A && A.location.href != f.iframeSrc) || w) {
                ...
                y.aborted && (r("upload aborted"), (a = null)),
                  ...
                  "success" === a
                    ? (f.success && f.success.call(f.context, D, "success", y), k.resolve(y.responseText, "success", y), h && e.event.trigger("ajaxSuccess", [y, f]))
                    : a && (void 0 === n && (n = y.statusText), f.error && f.error.call(f.context, y, a, n), k.reject(y, "error", n), h && e.event.trigger("ajaxError", [y, f, n])),
          ...
          if (
            ...
            f.iframeTarget
              ? (x = (g = e(f.iframeTarget)).attr2("name"))
                ? (m = x)
                : g.attr2("name", m)
              : (g = e('<iframe name="' + m + '" src="' + f.iframeSrc + '" />')).css({
                  position: "absolute",
                  top: "-1000px",
                  left: "-1000px",
                }),
          ...
          (b = C.clk) &&
            (x = b.name) &&
            !b.disabled &&
            ((f.extraData = f.extraData || {}), (f.extraData[x] = b.value), "image" == b.type && ((f.extraData[x + ".x"] = C.clk_x), (f.extraData[x + ".y"] = C.clk_y)));
          var F = 1,
            N = 2,
          ...
          var D,
            ...
            M = function (t, n, r) {
              ...
              return (
                a && "parsererror" === o.documentElement.nodeName && e.error && e.error("parsererror"),
        ...
        "function" == typeof t
          ...
          (u = (u = "string" == typeof (s = t.url || this.attr2("action")) ? e.trim(s) : "") || window.location.href || "") && (u = (u.match(/^([^#]+)/) || [])[1]),
          (t = e.extend(
            !0,
            {
              url: u,
      ...
      (e.fn.ajaxForm = function (i) {
        ...
        return i.delegation
          ? (e(document)
            ...
            this)
          : this.ajaxFormUnbind().bind("submit.form-plugin", i, t).bind("click.form-plugin", i, n);
      }),
    ...
    e.extend(e.fn, {
          ...
          return (
            ...
            n.settings.onsubmit &&
              ...
              this.submit(function (t) {
                ...
                return (
                  n.settings.debug && t.preventDefault(), n.cancelSubmit ? ((n.cancelSubmit = !1), r()) : n.form() ? (n.pendingRequest ? ((n.formSubmitted = !0), !1) : r()) : (n.focusInvalid(), !1)
                );
              })),
            n)
          );
      ...
      rules: function (t, n) {
        var r,
          ...
          l = this[0];
        if (t)
          switch (((r = e.data(l.form, "validator").settings), (i = r.rules), (a = e.validator.staticRules(l)), t)) {
            case "add":
        ...
        return (
          (o = e.validator.normalizeRules(e.extend({}, e.validator.classRules(l), e.validator.attributeRules(l), e.validator.dataRules(l), e.validator.staticRules(l)), l)).required &&
            ((s = o.required),
            delete o.required,
            (o = e.extend(
              {
      ...
      e.extend(e.validator, {
        ...
        prototype: {
          ...
          element: function (t) {
            ...
            return (
              ...
              void 0 === r
                ...
                : (this.prepareElement(r), (this.currentElements = e(r)), (i = !1 !== this.check(r)) ? delete this.invalid[r.name] : (this.invalid[r.name] = !0)),
          ...
          elements: function () {
            ...
            return e(this.currentForm)
              ...
              .filter(function () {
                return (
                  !this.name && t.settings.debug && window.console && console.error("%o has no name assigned", this), !(this.name in n || !t.objectLength(e(this).rules())) && ((n[this.name] = !0), !0)
                );
              });
          },
          clean: function (t) {
        ...
        attributeRules: function (t) {
          ...
          for (n in e.validator.methods)
            "required" === n ? ("" === (r = t.getAttribute(n)) && (r = !0), (r = !!r)) : (r = a.attr(n)),
        ...
        normalizeRules: function (t, n) {
          return (
            ...
            e.each(["rangelength", "range"], function () {
              var n;
              t[this] &&
                (e.isArray(t[this]) ? (t[this] = [Number(t[this][0]), Number(t[this][1])]) : "string" == typeof t[this] && ((n = t[this].split(/[\s,]+/)), (t[this] = [Number(n[0]), Number(n[1])])));
            }),
            e.validator.autoCreateRanges &&
              (t.min && t.max && ((t.range = [t.min, t.max]), delete t.min, delete t.max),
              t.minlength && t.maxlength && ((t.rangelength = [t.minlength, t.maxlength]), delete t.minlength, delete t.maxlength)),
            t
          );
        },
                      ...
                      !0,
                      {
                        ...
                        success: function (r) {
                          ...
                          (i.settings.messages[n.name].remote = o.originalMessage),
                            l
                              ? ((u = i.formSubmitted), i.prepareElement(n), (i.formSubmitted = u), i.successList.push(n), delete i.invalid[n.name], i.showErrors())
                              : ((a = {}), (s = r || i.defaultMessage(n, "remote")), (a[n.name] = o.message = e.isFunction(s) ? s(t) : s), (i.invalid[n.name] = !0), i.showErrors(a)),
                            (o.valid = l),
                            i.stopRequest(n, l);
                        },
                      },
        ...
        function (t, n, r) {
          ...
          if (0 == a.filter(":filled").length && this.optional(n)) i = !0;
            ...
            (o.month = a.filter("input[name*='[month]']").val()),
              ...
              (o.month = o.month - 1),
              o.year.length < 4 && (o.year = parseInt(o.year) < 50 ? 2e3 + parseInt(o.year) : 1900 + parseInt(o.year));
    ...
    (r.type = "text/css"),
      ...
      (window.mc = {
        ...
        mce_success_cb: function (t) {
          if ((e("#mce-success-response").hide(), e("#mce-error-response").hide(), "success" == t.result))
